...
import { IPartnerDoc } from "@/models/partnerDocs.model";
...
function Page() {
  ...
  const [partnerDocs, setPartnerDocs] = useState<IPartnerDoc | null>();
  const [partnerBank, setPartnerBank] = useState<IPartnerBank | null>();
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <AnimatedCard title="Documents" icon={<FileText size={18} />}>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <DocPreview label="License" url={partnerDocs?.licenseUrl} />
              <DocPreview
