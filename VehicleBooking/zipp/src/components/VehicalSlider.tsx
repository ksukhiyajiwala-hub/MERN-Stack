...
function VehicalSlider() {
  ...
  return (
    <div className="w-full bg-white py-2 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          <div
            ref={sliderRef}
            className="flex gap-5 overflow-x-auto pt-10 py-2 scroll-smooth pb-4 px-1"
            ...
            {VEHICLE_CATEGORIES.map((category, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -8 }}
                  className="group relative min-w-[200px] sm:min-w-[260px] flex-shrink-0 cursor-pointer"
                >
                  <motion.div
                    animate={{
        ...
        <motion.div
          ...
          className="flex items-center gap-6 mt-8 mb-8 pt-6 border-t border-zinc-100"
        >
