...
function PartnerDashboard() {
  ...
  useEffect(() => {
    ...
    console.log("partnerOnboardingSteps", userData?.partnerOnboardingSteps);
    console.log("Partner Status", userData?.videoKycStatus);
  }, [userData]);
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-100 to-gray-200 px-4 pt-28 pb-20">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        {userData?.partnerOnboardingSteps == 3 &&
        ...
        {userData?.partnerOnboardingSteps == 5 &&
          userData?.videoKycStatus == "approved" && (
            <StatusCard
              icon={<Check size={18} />}
              title="Video Kyc approved"
        ...
        {activeStep === 7 && vehicleData?.status === "pending" && (
          <StatusCard
            ...
            desc="Admin is reviewng your pricing"
          />
        )}
