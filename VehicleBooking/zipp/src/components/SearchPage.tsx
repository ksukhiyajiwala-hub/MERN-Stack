...
function SearchPage() {
  ...
  const pickUpLat = Number(params.get("pickLat"));
  const pickUpLon = Number(params.get("pickLon"));
                ...
                <VehicleCard
                  ...
                  onBook={() => {
                    const url = new URLSearchParams({
                      ...
                      dropUpLat: String(dropLat),
                      dropUpLon: String(dropLon),
                    });
