      ...
      <div className="flex flex-col flex-1 p-5 gap-4">
        ...
        <div className="flex items-end justify-between pt-3 border-t border-zinc-100">
          ...
          <motion.button
            ...
            onClick={onBook}
            className="group/btn flex items-center gap-2 bg-zinc-900 hover:bg-black text-white text-sm font-black px-6 py-3.5 rounded-2xl transition-colors shadow-md cursor-pointer"
          >
            Book
            <motion.div
              initial={{ x: 0 }}
